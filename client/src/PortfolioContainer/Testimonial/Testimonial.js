    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        if (entry.isIntersecting) {
          setIsVisible(true);
          observer.unobserve(testimonialRef.current); // Stop observing after the fade-in
        }
      },
      { threshold: 0.3 } // 30% of the section needs to be visible to trigger the animation
    );
              ...
              <div className="col-lg-12">
                <div className="testi-item">
                  <div className="testi-comment">
                    <p>
                      <i className="fa fa-quote-left" />
                      When he delivered my job, my head spun. It was so nice,
